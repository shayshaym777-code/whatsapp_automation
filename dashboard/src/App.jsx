...
function App() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-950 via-dark-900 to-dark-950">
      {/* Sidebar */}
      <aside className="fixed left-0 top-0 h-full w-64 bg-dark-900/80 backdrop-blur-xl border-r border-dark-700 z-50">
        <div className="p-6">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-10 h-10 bg-wa-green rounded-xl flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-xs text-dark-400">Automation System</p>
            </div>
          </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-dark-700">
          <div className="text-xs text-dark-400 mb-2">System Status</div>
