...
app.use(helmet());
app.use(cors());
app.use(express.json({ limit: '10mb' })); // Increased for large contact lists
...
app.use('/api/send', sendRouter);           // v7.0: POST /api/send
app.use('/api/campaigns', campaignsRouter); // v7.0: GET /api/campaign/:id/status
